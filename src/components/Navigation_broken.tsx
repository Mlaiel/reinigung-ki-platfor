  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${
      ...
      <div className="w-full">
        {/* TEST VISIBLE - COULEURS VIVES POUR DEBUG! */}
        <div className="sm:hidden">
          {/* TOP BAR ROUGE POUR TEST */}
          <div className="fixed top-0 left-0 right-0 z-50 bg-red-500 backdrop-blur-sm border-b border-border/50">
            <div className="flex items-center justify-center py-4">
              <span className="text-2xl font-bold text-white">🔥 NOUVEAU MOBILE DESIGN 🔥</span>
            </div>
          </div>
          ...
          {/* BOTTOM BAR ROUGE POUR TEST */}
          <div className="fixed bottom-0 left-0 right-0 z-50 bg-red-600 backdrop-blur-md border-t border-white shadow-2xl">
            <div className="grid grid-cols-5 gap-2 p-4">
              {/* Boutons colorés pour test */}
              <div className="bg-yellow-400 rounded-xl p-2 text-center">
                <div className="text-black font-bold">MENU</div>
              </div>
              <div className="bg-green-400 rounded-xl p-2 text-center">
                <div className="text-black font-bold">CHAT</div>
              </div>
              <div className="bg-blue-400 rounded-xl p-2 text-center">
                <div className="text-black font-bold">TEL</div>
              </div>
              <div className="bg-orange-400 rounded-xl p-2 text-center">
                <div className="text-black font-bold">WA</div>
              </div>
              <div className="bg-purple-400 rounded-xl p-2 text-center">
                <div className="text-black font-bold">MAIL</div>
              </div>
            </div>
          </div>
        ...
        <div className="hidden sm:flex items-center justify-between h-20 w-full">
          {/* Logo - Gauche */}
